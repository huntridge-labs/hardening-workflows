...
jobs:
  lint:
    uses: huntridge-labs/hardening-workflows/.github/workflows/linting.yml@2.8.0
    permissions:
      contents: read
      pull-requests: write
      checks: write
...
jobs:
  trivy-iac:
    uses: huntridge-labs/hardening-workflows/.github/workflows/scanner-trivy-iac.yml@2.8.0
    with:
  ...
  checkov:
    uses: huntridge-labs/hardening-workflows/.github/workflows/scanner-checkov.yml@2.8.0
    with:
      iac_path: 'infrastructure'
      framework: 'terraform'
```
...
jobs:
  trivy-container:
    uses: huntridge-labs/hardening-workflows/.github/workflows/scanner-trivy-container.yml@2.8.0
    with:
  ...
  grype:
    uses: huntridge-labs/hardening-workflows/.github/workflows/scanner-grype.yml@2.8.0
    with:
      image_ref: 'myapp:latest'
      fail_on_severity: high  # Fail on high or critical

  sbom:
    uses: huntridge-labs/hardening-workflows/.github/workflows/scanner-syft.yml@2.8.0
    with:
...
jobs:
  codeql:
    uses: huntridge-labs/hardening-workflows/.github/workflows/scanner-codeql.yml@2.8.0
    with:
      codeql_languages: 'python,javascript'
      enable_code_security: true

  opengrep:
    uses: huntridge-labs/hardening-workflows/.github/workflows/scanner-opengrep.yml@2.8.0
    with:
      fail_on_severity: medium  # Fail on medium or higher

  bandit:
    uses: huntridge-labs/hardening-workflows/.github/workflows/scanner-bandit.yml@2.8.0
    with:
      fail_on_severity: high  # Fail on high findings (Bandit's highest level)

  gitleaks:
    uses: huntridge-labs/hardening-workflows/.github/workflows/scanner-gitleaks.yml@2.8.0
    with:
