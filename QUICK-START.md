...
jobs:
  sast:
    uses: huntridge-labs/hardening-workflows/.github/workflows/reusable-security-hardening.yml@2.11.2
    with:
      scanners: codeql
    permissions:
      contents: read
...
jobs:
  trivy-iac:
    uses: huntridge-labs/hardening-workflows/.github/workflows/scanner-trivy-iac.yml@2.11.2
    with:
  ...
  checkov:
    uses: huntridge-labs/hardening-workflows/.github/workflows/scanner-checkov.yml@2.11.2
    with:
      iac_path: 'infrastructure'
...
jobs:
  scan-image:
    uses: huntridge-labs/hardening-workflows/.github/workflows/scanner-trivy-container.yml@2.11.2
    with:
